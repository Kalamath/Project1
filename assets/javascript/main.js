$(document).ready(function () {
    ...
    var userLocation = "";//ASHTON PUT THIS HERE :slightly_smiling_face:
    var search = "";

    $(".searchBtn").on("click", function (event) {
        event.preventDefault();
        $(".searchResultsDiv").show();
        var querlyURL = "https://api.data.charitynavigator.org/v2/Organizations?app_id=37bca05d&app_key=41fa3dccfcb5a6ae31cba2a08192de93&pageSize=5&search=" + search + "&rated=true&state=" + userLocation; $.ajax({
            url: queryURL,
            method: "GET"
        }).then(function (response) {
            console.log(response);
